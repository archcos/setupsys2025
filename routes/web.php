...
Route::middleware(['log-suspicious'])->group(function () {
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        Route::resource('proponents', ProponentController::class)->except(['show'])->middleware('role:user,staff,rpmo,au');
        Route::resource('projects', ProjectController::class)->middleware('role:staff,rpmo,au')->except(['destroy', 'show']);
        Route::delete('/projects/{id}', [ProjectController::class, 'destroy'])->middleware('role:rpmo')->name('projects.destroy');
        Route::resource('activities', ActivityController::class)->middleware('role:staff,rpmo,au');
    ...
    Route::middleware(['auth', 'role:rpmo,au'])->group(function () {
        ...
        Route::get('/refunds/{projectId}/download', [RefundController::class, 'downloadProjectRefunds']);
    });
