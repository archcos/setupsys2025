...
export default function LogManagement({
    ...
    const applyFilters = (newFilters, page = 1) => {
        ...
        debounceTimer.current = setTimeout(() => {
            router.get(
                route("logs.index"),
                { ...newFilters, per_page: perPage, page },
                { preserveState: true },
            );
        }, 300);
    };
                        ...
                        <span>
                            ...
                            {totalItems > 0 && (
                                <span className="text-gray-400">
                                    ...
                                    {Math.min(startIndex + perPage, totalItems)}
                                </span>
                            )}
                        </span>
                    </div>
                                ...
                                {displayLogs.length > 0 ? (
                                    displayLogs.flatMap((log) => [
                                        ...
                                        >
                                            ...
                                            <td className="px-4 py-3.5">
                                                <span
                                                    className={`inline-flex items-center px-2 py-0.5 rounded-md text-xs font-medium ring-1 ${getActionStyle(log.action)}`}
                                                >
                                                    {log.action}
                                                </span>
                                            </td>
                                            ...
                                            <td className="px-4 py-3.5">
                                                <span
                                                    className="text-xs text-gray-500 block max-w-[180px] truncate"
                                                                ...
                                                                {[
                                                                    ...
                                                                    ({
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            className={`rounded-lg border ${accent} overflow-hidden`}
                                                                        >
                                                                            <div
                                                                                className={`px-3 py-2 border-b border-current/10 text-xs font-semibold ${headerCls}`}
                                                                            >
                                                                                {
                                                                                    label
                                                                                }
