...
export default function MOAIndex({ moas, filters }) {
  ...
  const handleSearch = (e) => {
    e.preventDefault();
    router.get('/moa', { search }, { preserveState: true });
  };
          ...
          <div className="bg-white rounded-xl shadow p-6">
            ...
            <table className="min-w-full border border-gray-300 text-sm">
              <thead className="bg-gray-100">
                <tr>
                  <th className="border px-4 py-2">MOA ID</th>
                  <th className="border px-4 py-2">Project Title</th>
                  <th className="border px-4 py-2">Owner</th>
                  <th className="border px-4 py-2">PD Name</th>
                  <th className="border px-4 py-2">PD Title</th>
              ...
              <tbody>
                {moas.map((moa) => (
                  <tr key={moa.moa_id}>
                    <td className="border px-4 py-2">{moa.moa_id}</td>
