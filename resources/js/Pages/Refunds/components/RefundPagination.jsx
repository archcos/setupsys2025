...
const RefundPagination = React.memo(({ links, from, to, total, withAll }) => {
    ...
    const handlePaginationClick = useCallback(
        (url) => {
            ...
            // Append include_all to the pagination URL so it's preserved
            const parsed = new URL(url);
            parsed.searchParams.set("include_all", withAll ? "1" : "0");

            router.visit(parsed.toString(), {
                preserveScroll: true,
                preserveState: true,
            });
        },
