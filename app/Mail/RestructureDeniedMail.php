...
class RestructureDeniedMail extends Mailable
{
    ...
    public function build()
    {
        ...
        <body style='margin:0;padding:0;background-color:#f4f4f5;font-family:-apple-system,BlinkMacSystemFont,\"Segoe UI\",Roboto,\"Helvetica Neue\",Arial,sans-serif;'>
            <div style='max-width:580px;margin:32px auto;'>
                ...
                <div style='padding:28px 36px 24px;'>
                    <h1 style='margin:0 0 6px;font-size:20px;font-weight:600;color:#111827;'>Restructuring Request Denied</h1>
                    <p style='margin:0;font-size:13px;color:#9ca3af;'>Sent {$deniedDate}</p>
                </div>
                ...
                <div style='background:#ffffff;border:1px solid #e5e7eb;border-radius:10px;overflow:hidden;margin:0 0 24px;'>
                    ...
                    <div style='padding:16px 36px;background:#fef2f2;border-bottom:1px solid #f3f4f6;'>
                        <p style='margin:0;font-size:13px;color:#dc2626;font-weight:600;'>⚠ Restructuring request denied</p>
                    </div>

                    <!-- Denial Details Label -->
                    <table style='width:100%;border-collapse:collapse;border-bottom:1px solid #f3f4f6;'>
                        <tr>
                            <td style='padding:16px 18px;border-right:1px solid #f3f4f6;width:50%;'>
                                <p style='margin:0 0 5px;font-size:11px;color:#9ca3af;text-transform:uppercase;letter-spacing:.6px;'>Denied by</p>
                                <p style='margin:0;font-size:14px;font-weight:600;color:#111827;'>{$deniedBy}</p>
                            </td>
                            <td style='padding:16px 18px;width:50%;'>
                                ...
                                <p style='margin:0;font-size:14px;font-weight:600;color:#dc2626;'>Denied</p>
                            </td>
                        </tr>
                        {$remarksRowHtml}
                    </table>
                ...
                <div style='padding:0 36px 24px;'>
                    <p style='margin:0;font-size:13px;color:#6b7280;line-height:1.7;'>
                        For questions regarding the denial, please contact the Regional Director through the system.<br>
        ...
        return $this->subject('[DOSTNM-SIMS] Restructuring Request Denied - ' . $projectTitle)
                    ->html($htmlContent);
    }
}