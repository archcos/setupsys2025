        ...
        <body style='margin:0;padding:0;background-color:#f4f4f5;font-family:-apple-system,BlinkMacSystemFont,\"Segoe UI\",Roboto,\"Helvetica Neue\",Arial,sans-serif;'>
            <div style='max-width:580px;margin:32px auto;'>
                ...
                <div style='padding:28px 36px 24px;'>
                    <h1 style='margin:0 0 6px;font-size:20px;font-weight:600;color:#111827;'>Project Approved by Regional Director</h1>
                ...
                <div style='background:#ffffff;border:1px solid #e5e7eb;border-radius:10px;overflow:hidden;margin:0 0 24px;'>
                    ...
                    <div style='padding:24px 36px;border-bottom:1px solid #f3f4f6;'>
                        <p style='margin:0;font-size:14px;color:#6b7280;line-height:1.7;'>
                            Hello,<br><br>
                            We are pleased to inform you that your project has been approved by the Regional Director and is ready for implementation.
                        </p>
                    </div>

                    <!-- Status Badge -->
                    <div style='padding:16px 36px;background:#f0fdf4;border-bottom:1px solid #f3f4f6;'>
                        <p style='margin:0;font-size:13px;color:#16a34a;font-weight:600;'>✓ Approved by Regional Director</p>
                    </div>
                    ...
                    <table style='width:100%;border-collapse:collapse;'>
                        ...
                        <tr>
                            <td style='padding:12px 18px;font-size:13px;color:#9ca3af;'>Approved by</td>
                            <td style='padding:12px 18px;font-size:13px;color:#111827;text-align:right;'>{$approvedByName}</td>
                        </tr>
                    </table>
                ...
                <div style='padding:0 36px 24px;'>
                    <p style='margin:0;font-size:13px;color:#6b7280;line-height:1.7;'>
                        Please log in to DOSTNM-SIMS to review the approval details and proceed with implementation.<br>
