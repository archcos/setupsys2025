...
class ComplianceApprovalMail extends Mailable
{
    ...
    public function build()
    {
        ...
        <body style='margin:0;padding:0;background-color:#f4f4f5;font-family:-apple-system,BlinkMacSystemFont,\"Segoe UI\",Roboto,\"Helvetica Neue\",Arial,sans-serif;'>
            <div style='max-width:580px;margin:32px auto;'>
                ...
                <div style='padding:28px 36px 24px;'>
                    <h1 style='margin:0 0 6px;font-size:20px;font-weight:600;color:#111827;'>Project Compliance Recommended</h1>
                    <p style='margin:0;font-size:13px;color:#9ca3af;'>Sent {$approvalDate}</p>
                </div>
                ...
                <div style='background:#ffffff;border:1px solid #e5e7eb;border-radius:10px;overflow:hidden;margin:0 0 24px;'>
                    ...
                    <div style='padding:24px 36px;border-bottom:1px solid #f3f4f6;'>
                        <p style='margin:0;font-size:14px;color:#6b7280;line-height:1.7;'>
                            Hello, a project compliance has been reviewed and recommended by
                            <strong style='color:#111827;font-weight:600;'>{$approvedByName} (RPMU)</strong>.
                            This project is now escalated for regional director review and final approval.
                        </p>
                    </div>
                    ...
                    <table style='width:100%;border-collapse:collapse;border-bottom:1px solid #f3f4f6;'>
                        <tr>
                            <td style='padding:16px 18px;border-right:1px solid #f3f4f6;width:50%;'>
                                ...
                                <p style='margin:0;font-size:14px;font-weight:600;color:#111827;'>{$approvedByName}</p>
                            </td>
                            <td style='padding:16px 18px;width:50%;'>
                                ...
                                <p style='margin:0;font-size:14px;font-weight:600;color:#16a34a;'>Recommended by RPMU</p>
                            </td>
                        </tr>
                    </table>
                ...
                <div style='padding:0 36px 24px;'>
                    <p style='margin:0;font-size:13px;color:#6b7280;line-height:1.7;'>
                        Please review this project at your earliest convenience.<br>
        ...
        return $this->subject('[DOSTNM-SIMS] Project Compliance Recommended — ' . $projectTitle)
                    ->html($htmlContent);
    }
}