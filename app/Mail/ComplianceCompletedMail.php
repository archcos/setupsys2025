...
class ComplianceCompletedMail extends Mailable
{
    ...
    public function build()
    {
        ...
        <body style='margin:0;padding:0;background-color:#f4f4f5;font-family:-apple-system,BlinkMacSystemFont,\"Segoe UI\",Roboto,\"Helvetica Neue\",Arial,sans-serif;'>
            <div style='max-width:580px;margin:32px auto;'>
                ...
                <div style='padding:28px 36px 24px;'>
                    <h1 style='margin:0 0 6px;font-size:20px;font-weight:600;color:#111827;'>Project Compliance Complete</h1>
                    <p style='margin:0;font-size:13px;color:#9ca3af;'>Sent {$submittedDate}</p>
                </div>
                ...
                <div style='background:#ffffff;border:1px solid #e5e7eb;border-radius:10px;overflow:hidden;margin:0 0 24px;'>
                    ...
                    <div style='padding:24px 36px;border-bottom:1px solid #f3f4f6;'>
                        <p style='margin:0;font-size:14px;color:#6b7280;line-height:1.7;'>
                            Hello, a project compliance has been completed with all required documents and submitted by
                            <strong style='color:#111827;font-weight:600;'>{$submittedByName}</strong>.
                            It is now ready for your review and recommendation.
                        </p>
                    </div>
                    ...
                    <table style='width:100%;border-collapse:collapse;border-bottom:1px solid #f3f4f6;'>
                        <tr>
                            <td style='padding:16px 18px;border-right:1px solid #f3f4f6;width:50%;'>
                                <p style='margin:0 0 5px;font-size:11px;color:#9ca3af;text-transform:uppercase;letter-spacing:.6px;'>Submitted by</p>
                                <p style='margin:0;font-size:14px;font-weight:600;color:#111827;'>{$submittedByName}</p>
                            </td>
                ...
                <div style='padding:0 36px 24px;'>
                    <p style='margin:0;font-size:13px;color:#6b7280;line-height:1.7;'>
                        Please review the submission and take appropriate action in the system.<br>
        ...
        return $this->subject('[DOSTNM-SIMS] Project Compliance Complete — ' . $projectTitle)
                    ->html($htmlContent);
    }
}