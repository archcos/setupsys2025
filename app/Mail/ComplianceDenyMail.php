        ...
        $remarkRowHtml = $remark
            ? "<tr>
                <td colspan='2' style='padding:12px 18px;border-top:1px solid #f3f4f6;'>
                    ...
                    <p style='margin:0;font-size:13px;color:#111827;line-height:1.6;'>{$remark}</p>
                </td>
               </tr>"
            : '';
        ...
        <body style='margin:0;padding:0;background-color:#f4f4f5;font-family:-apple-system,BlinkMacSystemFont,\"Segoe UI\",Roboto,\"Helvetica Neue\",Arial,sans-serif;'>
            <div style='max-width:580px;margin:32px auto;'>
                ...
                <div style='padding:28px 36px 24px;'>
                    <h1 style='margin:0 0 6px;font-size:20px;font-weight:600;color:#111827;'>Project Compliance Denied</h1>
                    <p style='margin:0;font-size:13px;color:#9ca3af;'>Sent {$denialDate}</p>
                </div>
                ...
                <div style='background:#ffffff;border:1px solid #e5e7eb;border-radius:10px;overflow:hidden;margin:0 0 24px;'>
                    ...
                    <div style='padding:24px 36px;border-bottom:1px solid #f3f4f6;'>
                        <p style='margin:0;font-size:14px;color:#6b7280;line-height:1.7;'>
                            Hello, a project compliance has been denied by
                            <strong style='color:#111827;font-weight:600;'>{$deniedByName} (RPMO)</strong>.
                            The project status remains unchanged pending further review or revisions.
                        </p>
                    </div>
                    ...
                    <table style='width:100%;border-collapse:collapse;border-bottom:1px solid #f3f4f6;'>
                        <tr>
                            <td style='padding:16px 18px;border-right:1px solid #f3f4f6;width:50%;'>
                                ...
                                <p style='margin:0;font-size:14px;font-weight:600;color:#111827;'>{$deniedByName}</p>
                            </td>
                ...
                <div style='padding:0 36px 24px;'>
                    <p style='margin:0;font-size:13px;color:#6b7280;line-height:1.7;'>
                        Please review the project details and contact the RPMO for further clarification or to submit a revised compliance.<br>
