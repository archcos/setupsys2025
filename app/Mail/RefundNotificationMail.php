...
class RefundNotificationMail extends Mailable
{
    ...
    public function build()
    {
        ...
        $formattedRefundAmount = $this->refundAmount !== null
            ? '₱' . number_format($this->refundAmount, 2) : 'N/A';
        $formattedAmountDue = $this->amountDue !== null
            ? '₱' . number_format($this->amountDue, 2) : 'N/A';

        $statusColor = match(strtoupper($this->status)) {
            'PAID'         => '#16a34a',
            'UNPAID'       => '#dc2626',
            'RESTRUCTURED' => '#2563eb',
            default        => '#6b7280',
        ...
        <body style='margin:0;padding:0;background-color:#f4f4f5;font-family:-apple-system,BlinkMacSystemFont,\"Segoe UI\",Roboto,\"Helvetica Neue\",Arial,sans-serif;'>
            <div style='max-width:580px;margin:32px auto;'>
                ...
                <div style='padding:28px 36px 24px;'>
                    <h1 style='margin:0 0 6px;font-size:20px;font-weight:600;color:#111827;'>Refund update for {$month}</h1>
                ...
                <div style='background:#ffffff;border:1px solid #e5e7eb;border-radius:10px;overflow:hidden;margin:0 0 24px;'>
                    ...
                    <div style='padding:24px 36px;border-bottom:1px solid #f3f4f6;'>
                        <p style='margin:0;font-size:14px;color:#6b7280;line-height:1.7;'>
                            Dear <strong style='color:#111827;font-weight:600;'>{$ownerName}</strong>,
                            your refund record for <strong style='color:#111827;font-weight:600;'>{$month}</strong> has been updated.
                        </p>
                    </div>
                    ...
                    <table style='width:100%;border-collapse:collapse;'>
                        ...
                        <tr>
                            <td style='padding:12px 18px;font-size:13px;color:#9ca3af;'>Month</td>
